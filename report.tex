...
\begin{table*}
\centering
\caption{A summary of results obtained from running our grid of models.}
\begin{tabular}{c  c  c  c}
\toprule
\textbf{Yield Stress} (MPa) & \textbf{Internal Heating} (W/kg) & \textbf{Tectonic Regime} & \textbf{Time of Plate Tectonics Onset} (Gyr) \\
\hline
\multirow{2}{*}{50} & $5.2 \times 10^{-12}$ & Plate Tectonics & 4.6  \\
 & $10.4 \times 10^{-12}$ & Plate Tectonics & 1.1  \\
\hline
\multirow{2}{*}{75} & $5.2 \times 10^{-12}$ & Plate Tectonics & 6.3  \\
 & $10.4 \times 10^{-12}$ &  &  \\
\hline
\multirow{2}{*}{100} & $5.2 \times 10^{-12}$ & Stagnant Lid & N/A \\
 & $10.4 \times 10^{-12}$ & Stagnant Lid & N/A \\
\hline
\multirow{2}{*}{150} & $5.2 \times 10^{-12}$ & Stagnant Lid & N/A \\
 & $10.4 \times 10^{-12}$ & Stagnant Lid & N/A \\
\hline
\multirow{2}{*}{200} & $5.2 \times 10^{-12}$ & Stagnant Lid & N/A \\
 & $10.4 \times 10^{-12}$ & Stagnant Lid & N/A \\
\hline
\multirow{2}{*}{250} & $5.2 \times 10^{-12}$ & Stagnant Lid & N/A \\
 & $10.4 \times 10^{-12}$ & Stagnant Lid & N/A \\
\toprule
\label{tab:results}
\end{tabular}
